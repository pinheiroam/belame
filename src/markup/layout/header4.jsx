                    ...
                    <div className="sticky-header main-bar-wraper navbar-expand-lg">
                        <div className="main-bar clearfix">
                            <div className="container clearfix">
                                ...
                                <button className={`${this.state.toggleBtn.className}`} type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation" onClick={() => this.onToggle()}>
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                </button>
                                    ...
                                    <ul className="nav navbar-nav">
                                        ...
                                        <li><Link to={'#'}>Nossos Produtos <i className="fa fa-chevron-down"></i></Link>
                                            <ul className="sub-menu">
                                                ...
                                                <li><Link to={'./#nossos-produtos'} className="dez-page" onClick={() => this.onToggle()} type="button" 
                                                        data-toggle="collapse" 
                                                        data-target="#navbarNavDropdown" 
                                                        aria-controls="navbarNavDropdown" 
                                                        aria-expanded="true" 
                                        ...
                                        <li><Link to={'#'}>Passo a Passo <i className="fa fa-chevron-down"></i></Link>
                                            <ul className="sub-menu">
                                            <li><Link to={'./#passoapasso'} className="dez-page"  onClick={() => this.onToggle()} type="button" 
                                                        data-toggle="collapse" 
                                                        data-target="#navbarNavDropdown" 
                                                        aria-controls="navbarNavDropdown" 
                                                        aria-expanded="true" 
                                        ...
                                        <li><Link to={'./#contato'}  onClick={() => this.onToggle()} type="button" 
                                                        data-toggle="collapse" 
                                                        data-target="#navbarNavDropdown" 
                                                        aria-controls="navbarNavDropdown" 
                                                        aria-expanded="true" 
