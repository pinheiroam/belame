                        ...
                        <div className="container wow fadeIn" data-wow-delay="0.5s">
                            <div className="row">
                                ...
                                <div className="col-7 col-lg-2 col-md-6 col-sm-6 footer-col-4">
                                    <div className="widget widget_services border-0">
                                        <h5 className="m-b30 text-white">Nossos Produtos</h5>
                                        <ul>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 footer-col-4">
                                    <div className="widget widget_getintuch">
                                        ...
                                        <ul>
                                            ...
                                            <li><i className="ti-mobile"></i><strong>Telefone</strong>
                                                Marco Aurélio: +55 67 9 8199-7782<br></br>
                                                Maurício: +55 67 9 9971-2775<br></br>
                                                Rosana: +55 67 9 9945-6263
                                            </li>
                                            <li><i className="ti-email"></i><strong>email</strong> belame@gmail.com</li>
                                        </ul>
                                    </div>
                                </div>
